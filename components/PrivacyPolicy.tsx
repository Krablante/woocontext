      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-slate-700 leading-relaxed">
          <section>
            ...
            <p>
              Welcome to WooContext AI ("we," "our," or "us"). We respect your privacy and are committed to protecting your personal data. 
              This privacy policy will inform you as to how we look after your personal data when you visit our website (woocontext.com) 
              or use our WordPress plugin, and tell you about your privacy rights and how the law protects you.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-4 space-y-2">
              ...
              <li><strong>Usage Data:</strong> includes information about how you use our website and plugin.</li>
            </ul>
          </section>
